...
class ConsultationParametersWidget extends StatefulWidget {
  const ConsultationParametersWidget({super.key});

  @override
  State<ConsultationParametersWidget> createState() => _ConsultationParametersWidgetState();
}

class _ConsultationParametersWidgetState extends State<ConsultationParametersWidget> {
  String _appointmentDuration = "30 minutes";
  String _bufferTime = "10 minutes";

  final List<String> _durationOptions = ["15 minutes", "30 minutes", "45 minutes", "60 minutes"];
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              style: const TextStyle(
                ...
                fontFamily: 'Inter', // Assuming standard font, will inherit from theme
              ),
              onChanged: onChanged,
